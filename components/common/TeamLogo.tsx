...
export const TeamLogo = ({
  ...
  const spriteId = useMemo(
    () => getLogoId(teamAbbreviation, league, Infinity),
    [league, teamAbbreviation],
  );
  ...
  if (
    ...
    return (
      ...
      <img
        className={className}
        src={`https://index.simulationhockey.com/league_logos/${spriteId}.svg`}
        onLoad={() => onLoad?.()}
      />
    );
  }
  ...
  return (
    ...
    <img
      className={className}
      src={`https://index.simulationhockey.com/stack/${league.toLowerCase()}.stack.svg#${spriteId}`}
